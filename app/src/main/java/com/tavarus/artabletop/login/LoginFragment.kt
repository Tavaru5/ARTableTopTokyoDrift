package com.tavarus.artabletop.login
...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        emailInputLayout.doOnLayout {
            val emailParams = marginSpacerEmail.layoutParams as ConstraintLayout.LayoutParams
            emailParams.setMargins(emailParams.leftMargin, emailParams.topMargin, emailParams.rightMargin, it.height)
            marginSpacerEmail.layoutParams = emailParams
        }

        passwordInputLayout.doOnLayout {
            val passwordParams = marginSpacerPassword.layoutParams as ConstraintLayout.LayoutParams
            passwordParams.setMargins(passwordParams.leftMargin, passwordParams.topMargin, passwordParams.rightMargin, it.height)
            marginSpacerPassword.layoutParams = passwordParams
        }
