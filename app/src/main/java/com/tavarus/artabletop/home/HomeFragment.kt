...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        boardListAdapter = BoardListAdapter(viewModel.boardsList.value!!.boards, requireContext()) { index: Int ->
            viewModel.goToBoard(index)
        }
        ...
        viewModel.boardsList.observe(viewLifecycleOwner, boardObserver)
